...
export default function ResultsPage() {
  ...
  const big5Explain: Record<keyof Big5["percent"], string> = {
    E: "أعلى = ميل للتفاعل واللعب الجماعي.",
    O: "أعلى = حب التجارب الجديدة والفضول.",
    A: "أعلى = تعاون وتعاطف وراحة اجتماعية.",
    C: "أعلى = تنظيم ومثابرة وإكمال المهام.",
    N: "أعلى = حساسية أكبر للتغيرات والمثيرات.",
  };
            ...
            <section className="mb-8">
              ...
              <div className="rounded-xl p-4" style={{ border: "1px solid #f0f0f5" }}>
                ...
                <p className="text-sm text-gray-600 mt-3">
                  ثبّت روتينًا يوميًا قصيرًا (10–15 دقيقة) وابدأ بالأبسط ثم زد بالتدرّج.
                </p>
              </div>
            </section>
