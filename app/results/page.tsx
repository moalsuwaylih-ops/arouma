...
function envAdvice(percent: number): { intro: string; bullets: string[] } {
  ...
  return {
    intro: "ممتاز! اعمل على التنويع الخفيف وزيادة مشاركة الطفل في الاختيار.",
    bullets: [
      "دع الطفل يختار بين نشاطين متقاربين كل يوم.",
      "أضِف هدفًا أسبوعيًا صغيرًا (ملصق مكافأة عند إكمال 5 أيام).",
      "قدّم نشاطًا مشتركًا مع أخ/أخت مرة واحدة أسبوعيًا.",
      "صوّروا نتيجة الأسبوع وشاركوها مع المعلم لتعزيز الدافعية.",
    ],
  };
}
...
function envAdvice(percent: number): { intro: string; bullets: string[] } {
  ...
  return {
    intro:
      "ممتاز! اعمل على التنويع الخفيف وزيادة مشاركة الطفل في الاختيار.",
    bullets: [
      "دع الطفل يختار بين نشاطين متقاربين كل يوم.",
      "أضِف هدفًا أسبوعيًا صغيرًا (ملصق مكافأة عند إكمال 5 أيام).",
      "قدّم نشاطًا مشتركًا مع أخ/أخت مرة واحدة أسبوعيًا.",
