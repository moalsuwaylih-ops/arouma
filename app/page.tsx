    ...
    >
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 pt-6">
        <div className="flex items-center gap-2">
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#7b5fe8] to-[#49d5a3] text-white font-bold">أ</span>
          <span className="text-lg font-extrabold tracking-tight text-[#3c2e7e]">أرومة</span>
        </div>
        ...
        <Link
          href="/assessment"
          className="rounded-xl bg-gradient-to-r from-[#7b5fe8] to-[#49d5a3] px-4 py-2 text-white shadow-md transition hover:scale-[1.02] hover:shadow-lg"
        >
          ابدأ الآن
        </Link>
      </header>
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <h1 className="mt-4 text-3xl md:text-5xl font-extrabold leading-[1.2] text-[#31255f]">
              نفهم طفلك <span className="bg-gradient-to-r from-[#7b5fe8] to-[#49d5a3] bg-clip-text text-transparent">بِعُمق</span>،
              ونبني حوله خطة <span className="whitespace-nowrap">تُشبهه 💜</span>
            </h1>
            ...
            <p className="mt-3 text-xs text-gray-500">
              مدة الاستبانة 10–15 دقيقة • 48 سؤالًا خفيفًا • البيانات سرّية
            </p>
          </div>
      ...
      <section id="how" className="mx-auto mt-20 w-full max-w-6xl px-6">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          {[
            { n: "1", t: "ابدأ الاستبانة", d: "أسئلة قصيرة تُغطي السمات الكبرى الخمس للشخصية، نظرية الذكاءات المتعددة، أنماط التعلم، والبيئة الأسرية." },
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-3 text-xs text-gray-500">بالضغط على البدء، توافق على سياسة الخصوصية واستخدام البيانات لأغراض التقييم.</p>
        </div>
      </section>
      ...
      <section id="faq" className="mx-auto my-20 w-full max-w-6xl px-6">
        <div className="rounded-3xl border border-[#efeafd] bg-white p-6 md:p-8 shadow-[0_10px_40px_rgba(125,115,185,0.08)]">
          <h3 className="text-xl font-extrabold text-[#3c2e7e]">أسئلة سريعة</h3>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div>
              <p className="font-semibold">هل البيانات سرّية؟</p>
              <p className="text-sm text-[#5b5672] mt-1">نعم، تُستخدم فقط لأغراض التقييم والتوصيات، وتُحفظ محليًا مبدئيًا.</p>
            </div>
            <div>
              <p className="font-semibold">هل يصلح لكل الأعمار؟</p>
              <p className="text-sm text-[#5b5672] mt-1">موجّه للأطفال حتى سن 13 سنة.</p>
            </div>
          </div>
        </div>
      </section>
